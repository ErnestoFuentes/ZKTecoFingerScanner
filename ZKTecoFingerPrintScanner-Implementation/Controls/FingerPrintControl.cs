...
namespace Dofe_Re_Entry.UserControls.DeviceController
{
    public partial class FingerPrintControl : UserControl
    {
        ...
        zkfp fpInstance = new zkfp(); // PASO 1 IMPLEENT THE PROVIDED CLASS ###############################
        zkfp DataHolder = new zkfp();
        ...
        // [ INITALIZE DEVICE ]
        private void bnInit_Click(object sender, EventArgs e) // PASO 2 INICIALIZA EL DISPOISTIVO   
        {
